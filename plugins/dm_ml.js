...
let _diamond9 = `⦿ 963 💎 = Rp 198.600 💰`;
let _diamond10 = `⦿ 1412 💎 = Rp 280.600 💰`;
let _diamond11 = `⦿ 2195 💎 = Rp 426.200 💰`;
let _diamond12 = `⦿ 3688 💎 = Rp 708.100 💰`;
let _diamond13 = `⦿ 4394 💎 = Rp 848.600 💰`;

let handler = async (m, { conn, usedPrefix: _p, text, isOwner, command }) => {
    let prefix = _p
    let tampil = [`${_diamond1}`, `${_diamond2}`, `${_diamond3}`, `${_diamond4}`, `${_diamond5}`, `${_diamond6}`, `${_diamond7}`, `${_diamond8}`, `${_diamond9}`, `${_diamond10}`, `${_diamond11}`, `${_diamond12}`, `${_diamond13}`]
    let tampil1 = tampil.filter(v => ![`${_diamond1}`].includes(v))
    let row = ['ml', 'ml1', 'ml2', 'ml3', 'ml4', 'ml5', 'ml6', 'ml7', 'ml8', 'ml9', 'ml10', 'ml11', 'ml12', 'ml13']
